...
- **Projects (`docs/_staging_para/1-projects`)**: Active tasks with a deadline.
- **Areas (`docs/_staging_para/2-areas`)**: Ongoing responsibilities.
- **Resources (`docs/_staging_para/3-resources`)**: Topics of interest.
- **Archives (`docs/_staging_para/4-archives`)**: Completed work.
...
3.  **Context**: Always check `docs/_staging_para` for existing context on active projects.
